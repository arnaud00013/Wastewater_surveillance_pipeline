...
def run_core_iPMVC(wp_path,current_sample, nb_t_profiling):
	...
	os.system("java -jar $EBROOTVARSCAN/VarScan.v2.4.1.jar pileup2snp {0}{1}.pileup --min-coverage 50 --min-reads2 1 --min-var-freq 0.25 > {0}out/variants_{1}.tab".format(wp_path, current_sample))
